...
public class NotaFiscalTest {
    ...
    @Before
    public void setup() {
        this.defaultBill = new Bill("Matheus Oliveira", "Rua do Sol, 89", serviceType, billValue);
    ...
    public void shouldGetClientName() {
        assertEquals("Matheus Oliveira", defaultNotaFiscal.getClientName());
    }
    ...
    public void shouldHasToString() {
        ...
        String expectedString = "Client: Matheus Oliveira\n" +
                "Invoice amount: " + formattedBillValue + "\n" +
    ...
    public void testToStringWithZeroValue() {
        Bill bill = new Bill("Pedro Augusto", "Rua do Sol, 89", serviceType, 0);
